...
LIGHT_CONTROLLERS = {
    Planet.Mercury: LightController(PinSpec(0x41, 0), 
                                    PinSpec(0x41, 8),
                                    PinSpec(0x40, 0),
                                    PinSpec(0x40, 8)),
    Planet.Venus: LightController(PinSpec(0x41, 1),
                                  PinSpec(0x41, 9),
                                  PinSpec(0x40, 1),
                                  PinSpec(0x40, 9)),
    Planet.Earth: LightController(PinSpec(0x41, 2),
                                  PinSpec(0x41, 10),
                                  PinSpec(0x40, 2),
                                  PinSpec(0x40, 10)),
    Planet.Mars: LightController(PinSpec(0x41, 3),
                                 PinSpec(0x41, 11),
                                 PinSpec(0x40, 3),
                                 PinSpec(0x40, 11)),
    Planet.Jupiter: LightController(PinSpec(0x41, 4),
                                    PinSpec(0x41, 12),
                                    PinSpec(0x40, 4),
                                    PinSpec(0x40, 12)),
    Planet.Saturn: LightController(PinSpec(0x41, 5),
                                   PinSpec(0x41, 13),
                                   PinSpec(0x40, 5),
                                   PinSpec(0x40, 13)),
    Planet.Uranus: LightController(PinSpec(0x41, 6),
                                   PinSpec(0x41, 14),
                                   PinSpec(0x40, 6),
                                   PinSpec(0x40, 14)),
    Planet.Neptune: LightController(PinSpec(0x41, 7),
                                    PinSpec(0x41, 15),
                                    PinSpec(0x40, 7),
                                    PinSpec(0x40, 15))
}
